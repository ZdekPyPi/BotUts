...
class Log(Base):
    ...
    def __init__(self,level,date=None,function=None,file=None,module=None,path=None,line=None,message=None,extra_1=None):
    ...
    def get_id_proc(self):
        if self.level in ('DEBUG','CRON'): return None
