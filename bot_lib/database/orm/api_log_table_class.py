...
class ApiMonitor(Base):
    ...
    def __init__(self, method, date=None, function=None, url=None, host=None, url_path=None,
                 time_exec=None, status_code=None, file=None, module=None, path=None, line=None, message=None):
